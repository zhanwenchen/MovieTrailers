...
the_battle_of_algiers = media.Movie("The Battle of Algiers",
                                    "The last years of French colonial rule in Algeria",
...
babel = media.Movie("Babel",
                    "A chain of events occurs like the proverbial butterfly that flaps its wings",
...
tokyo_story = media.Movie("Tokyo Story",
                          "An old couple's visit to their children invokes a heartbreaking reality",
                          "https://upload.wikimedia.org/wikipedia/en/5/5f/Tokyo_Story_poster.jpg",
                          "https://www.youtube.com/watch?v=J_LXe4PIKtQ")

eat_drink_man_woman = media.Movie("Eat Drink Man Woman",
                                  "A man and his three daughters look for recipes for love",
...
the_lives_of_others = media.Movie("The Lives of Others",
                                  "A surveillance agent gets involved in his subjects' lives",
                                  "https://upload.wikimedia.org/wikipedia/en/9/9f/Leben_der_anderen.jpg",
                                  "https://www.youtube.com/watch?v=n3_iLOp6IhM")

wadjda = media.Movie("Wadjda",
                     "A girl competes in a Koran recitation competition in order to buy a bike",
                     "https://upload.wikimedia.org/wikipedia/en/f/f4/Wadjda_%28film%29.jpg",
                     "https://www.youtube.com/watch?v=3koigluYOH0")

a_separation = media.Movie("A Separation",
                           "A family chosses between moving abroad for the child and a sick parent",
...
tinker_tailor_soldier_spy = media.Movie("Tinker Tailor Soldier Spy",
                                        "A spymaster must uncover a Soviet double agent",
                                        "http://www.gstatic.com/tv/thumb/movieposters/8702008/p8702008_p_v8_ah.jpg",
                                        "https://www.youtube.com/watch?v=LPKhWXhiMSw")

le_samourai = media.Movie("Le Samourai",
                          "A professional hitman gets driven into a corner after being caught in the act",
...
omar = media.Movie("Omar",
                   "Love is elusive for a Palestinian freedom fighter",
...
movies = [the_battle_of_algiers, babel, tokyo_story, eat_drink_man_woman, the_lives_of_others, wadjda,
          a_separation, tinker_tailor_soldier_spy, le_samourai, omar]
